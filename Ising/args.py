...
group.add_argument(
    ...
    type=int,
    default=1,
    help='importance sampling steps to improve sampling efficiency')
group.add_argument(
    '--importance_sampling_epsilon',
    type=float,
    default=0.1,
    help='clip boundary to update pramaters')
...
group.add_argument("--name", type=str, default="none", choices=["benchmark", "softmax", "softmaxlog", "tanh", "best"], help="name")
